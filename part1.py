...
def gradientDescent(X, y_noise, y_true, niter, alpha):
    a_gd = np.zeros((d,1))
...
def main():
    ...
    # Part b
    niter = 20
    #err_gd_1 = gradientDescent(X, y_noise, y_true, niter, 0.00005)
    err_gd_2 = gradientDescent(X, y_noise, y_true, niter, 0.0005)
    #err_gd_3 = gradientDescent(X, y_noise, y_true, niter, 0.0007)
